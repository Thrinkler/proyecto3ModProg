...
document.querySelector("#btn-saludo").addEventListener("click", () => {
    ...
    const i = (mensajes.indexOf($saludo.textContent) + 1) % mensajes.
        length;
...
function render() {
    ...
    <div style ="margin - left : auto ; display : flex ; gap :6 px">
    <button data - act =" toggle " data -id="$ {t. id }">Toggle </
    button >
